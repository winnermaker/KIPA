        ...
        <form action="pexam_con.php" method="post" class="needs-validation" novalidate>
            ...
            <div class="row mt-5">
                ...
                <div class="form-group col">
                    ...
                    <input type="number" step="0.1" min="0" placeholder="" class="form-control" name="height" id="Height" value="<?php echo (isset($pexamData['height']))?$pexamData['height']:'';?>">
                </div>

                <div class="form-group col">
                    <label for="headcircumference" class="form-label">Head circumference (cm)</label>
                    <input type="number" step="0.1" min="0" class="form-control" name="headcircumference" id="headcircumference" value="<?php echo (isset($pexamData['headcircumfrence']))?$pexamData['headcircumfrence']:'';?>">
                </div>
            </div>
            ...
            <div class="row mt-3">
                <div class="form-group col-3">
                    ...
                    <input type="number" step="0.1" min="0" placeholder="" class="form-control" name="bmi" id="BMI" value="<?php echo (isset($pexamData['bmi']))?$pexamData['bmi']:'';?>">
                </div>

                <div class="form-group col-3">
                    <label for="MUAC" class="form-label">MUAC (cm)</label>
                    <input type="number" step="0.1" min="0" placeholder="" class="form-control" name="muac" id="MUAC" value="<?php echo (isset($pexamData['muac']))?$pexamData['muac']:'';?>">
                </div>

                <div class="form-group col-3">
                    <label for="temperature" class="form-label">Temperature (Celsius)</label>
                    <input type="number" step="0.1" placeholder="" class="form-control" name="temperature" id="temperature" value="<?php echo (isset($pexamData['temperature']))?$pexamData['temperature']:'';?>">
                </div>
